            ...
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <form method="post" action="">
                <div class="form-group">
                  <input type="text" name="user" class="form-control form-control-lg" id="user" placeholder="Username">
                </div>
                <div class="form-group">
                  <input type="password" name="pass" class="form-control form-control-lg" id="exampleInputPassword1" placeholder="Password">
                </div>
                <div class="mt-3">
                  <button name="Login" type="submit" class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn">SIGN IN</button>
                </div>
...
if (isset($_POST["Login"])) {
  ...
  $sql1 = "select * from `$tbladmin` where `username`='$usr' and `password`='$pas' and `status`='Aktif'";
